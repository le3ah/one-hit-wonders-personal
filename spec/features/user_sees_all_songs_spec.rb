...
describe 'song index page' do
  describe 'as a visitor' do
    it 'sees list of songs' do
      song_1 = Song.create(title: "Don't Stop Believin'", length: 100, play_count: 0)
      song_2 = Song.create(title: "Sal is Awesome", length: 100, play_count: 0)
      song_3 = Song.create(title: "Ellen Mary is Amazing", length: 100, play_count: 0)
